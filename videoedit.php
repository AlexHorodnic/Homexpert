...
<html lang="en">
  ...
  <body>
      <div class="container-fluid">
        ...
        <div class="container">
            <div class="row" style="background-color:#fc7930; height: 170px; align-items:center; top:0px;">
                <div class="col-12">
                    <div style="color:white; font-size: 45px;">Hire the best Video Editors</div>
                    <div style="color:white; font-size: 20px;">Get to know top Video Editors. And say hello to the newest member of your team.</div>
                </div>
            </div>
            <div class="row row2" style="height:380px; align-items:center; margin-bottom:100px; ">
                <div class="col-3" style="border-right: 1px solid #d35400; height: 300px; text-align:center;">
                    <div style=" padding-top:20px;">
                        <?php
                            $result = mysqli_query($link,"SELECT * FROM video_audio where id='1'");
                    ...
                    <button type="button" class="btn btn-dark" style="margin-top:20px; background-color:#d35400; border:none;">See More</button>
                </div>
                <div class="col-3" style="border-right: 1px solid #d35400; height: 300px; text-align:center;">
                    <div style=" padding-top:20px;">
                        <?php
                            $result = mysqli_query($link,"SELECT * FROM video_audio where id='2'");
                ...
                <div class="col-3" style="height: 300px; text-align:center;">
                    <div style=" padding-top:20px;">
                        <?php
                            $result = mysqli_query($link,"SELECT * FROM video_audio where id='4'");
