...
<html lang="en">
  <head>
    ...
    <title>Writing & Translation - Book Editing</title>
      ...
      <div class="container-fluid">
        ...
        <div class="container">
            <div class="row" style="background-color:#fc7930; height: 170px; align-items:center;">
                <div class="col-12">
                    <div style="color:white; font-size: 45px;">Hire the best Book Editors</div>
                    <div style="color:white; font-size: 20px;">Get to know top Book Editors. And say hello to the newest member of your team.</div>
                </div>
            </div>
            <div class="row row2" style="height:380px; align-items:center;">
                <div class="col-3" style="border-right: 1px solid #d35400; height: 300px; text-align:center;">
                    <div style=" padding-top:20px;">
                        <?php
                            $result = mysqli_query($link,"SELECT * FROM writing_translation where id='1'");
                    ...
                    <button type="button" class="btn btn-dark" style="margin-top:20px; border:none;"><a href="danielle.php">See More</a></button>
                </div>
                <div class="col-3" style="border-right: 1px solid #d35400; height: 300px; text-align:center;">
                    <div style=" padding-top:20px;">
                        <?php
                            $result = mysqli_query($link,"SELECT * FROM writing_translation where id='2'");
                    ...
                    <button type="button" class="btn btn-dark" style="margin-top:20px; border:none;"><a href="jeff.php">See More</a></button>
                </div>
                <div class="col-3" style="border-right: 1px solid #d35400; height: 300px; text-align:center;">
                    <div style=" padding-top:20px;">
                        <?php
                            $result = mysqli_query($link,"SELECT * FROM writing_translation where id='3'");
                    ...
                    <button type="button" class="btn btn-dark" style="margin-top:20px; border:none;"><a href="angela.php">See More</a></button>
                </div>
                <div class="col-3" style="height: 300px; text-align:center;">
                    <div style=" padding-top:20px;">
                        <?php
                            $result = mysqli_query($link,"SELECT * FROM writing_translation where id='4'");
                    ...
                    <button type="button" class="btn btn-dark" style="margin-top:20px; border:none;"><a href="bri.php">See More</a></button>
                </div>
            </div>
            <!-- SHOW DATABASE POST -->
            <div class="row" >
            <div class="col-6" style="background-color: black; color:white; padding-top:40px;  opacity:80%;">
                        <?php
                            $result = mysqli_query($link,"SELECT * FROM posts where id='5'");
