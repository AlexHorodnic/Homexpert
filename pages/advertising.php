...
<html lang="en">
  <head>
    ...
    <title>Marketing - Social Media Advertising</title>
      ...
      <div class="container-fluid">
        ...
        <div class="container">
            <div class="row" style="background-color:#fc7930; height: 170px; align-items:center;">
                <div class="col-12">
                    <div style="color:white; font-size: 45px;">Hire the best Social Media Advertisers</div>
                    <div style="color:white; font-size: 20px;">Get to know top Social Media Advertisers. And say hello to the newest member of your team.</div>
                </div>
            </div>
            <div class="row row2" style="height:380px; align-items:center;">
                <div class="col-3" style="border-right: 1px solid #d35400; height: 300px; text-align:center;">
                    <div style=" padding-top:20px;">
                        <?php
                            $result = mysqli_query($link,"SELECT * FROM marketing where id='1'");
                    ...
                    <button type="button" class="btn btn-dark" style="margin-top:20px; border:none;"><a href="rachel.php">See More</a></button>
                </div>
                <div class="col-3" style="border-right: 1px solid #d35400; height: 300px; text-align:center;">
                    <div style=" padding-top:20px;">
                        <?php
                            $result = mysqli_query($link,"SELECT * FROM marketing where id='2'");
                    ...
                    <button type="button" class="btn btn-dark" style="margin-top:20px; border:none;"><a href="roanne.php">See More</a></button>
                </div>
                <div class="col-3" style="border-right: 1px solid #d35400; height: 300px; text-align:center;">
                    <div style=" padding-top:20px;">
                        <?php
                            $result = mysqli_query($link,"SELECT * FROM marketing where id='3'");
                    ...
                    <button type="button" class="btn btn-dark" style="margin-top:20px; border:none;"><a href="maria.php">See More</a></button>
                </div>
                <div class="col-3" style="height: 300px; text-align:center;">
                    <div style=" padding-top:20px;">
                        <?php
                            $result = mysqli_query($link,"SELECT * FROM marketing where id='4'");
                    ...
                    <button type="button" class="btn btn-dark" style="margin-top:20px; border:none;"><a href="adnan.php">See More</a></button>
                </div>
            </div>
            <!-- SHOW DATABASE POST -->
            <div class="row" >
            <div class="col-6" style="background-color: black; color:white; padding-top:40px;  opacity:80%;">
                        <?php
                            $result = mysqli_query($link,"SELECT * FROM posts where id='4'");
